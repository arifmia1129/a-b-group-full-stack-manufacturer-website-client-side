        ...
        <div>
            ...
            <footer class="footer px-10 py-4 border-t bg-secondary text-white border-base-300">
                <div class="items-center grid-flow-col">
                    ...
                    <p ><span className='text-2xl font-bold'>A&B Group of Industries Ltd.</span> <br /> <span>Copyright &copy; {new Date().getFullYear()} - All right reserved by ACME Industries Ltd</span></p>
                </div>
