...
const Footer = () => {
    return (
        <div>
            <footer class="footer p-10 bg-secondary text-white font-bold">
                <div>
                    <span class="text-xl text-white">Services</span>
                ...
                <div>
                    <span class="text-xl text-white">Company</span>
                ...
                <div>
                    <span class="text-xl text-white">Legal</span>
            ...
            <footer class="footer px-10 py-4 border-t bg-secondary text-white border-base-300">
                <div class="items-center grid-flow-col">
                    ...
                    <p ><span className='text-2xl font-bold'>A&B Group of Industries Ltd.</span> <br /> <span>Copyright &copy; {new Date().getFullYear()} - All right reserved by A&B Group of Industries Ltd</span></p>
                </div>
