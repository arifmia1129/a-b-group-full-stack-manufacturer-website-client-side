                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="form-control  max-w-xs">
                        ...
                        <input
                            ...
                            type="number" placeholder="Rating stars" className="input input-bordered  max-w-xs" />
                        <label className="label">
                    ...
                    <div className="form-control  max-w-xs">
                        ...
                        <textarea
                            ...
                            type="text" placeholder="Add your review" className="input input-bordered  max-w-xs" />
                        <label className="label">
                            <span className="label-text-alt text-red-500">
